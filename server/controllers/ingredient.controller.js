...
exports.list = async (req, res) => {
   ...
   const ingredientObjectArray = data.rows.map(row => {
      const ingredient = { foodId: row.food_id, foodDescription: row.food_description };
      return ingredientUtils.verifyObject(ingredient, false); 
   });
